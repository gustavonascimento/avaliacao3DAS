...
public class Viagem {
	...
	public int getDuracaoHoras() {
		CalculoDuracaoHoras calculoDuracaoHoras = new CalculoDuracaoHoras(this);
		
		return calculoDuracaoHoras.getDuracaoHoras();
	}

	public int getDuracaoMinutos() {
		CalculoDuracaoMinutos calculoDuracaoMinutos = new CalculoDuracaoMinutos(this);
		
		return calculoDuracaoMinutos.getDuracaoMinutos();
	}
